...
public class soccerTeam extends team{
    ...
    public soccerTeam(String name){
        super(name);
        position.put("center defenser",new ArrayList<member>());
        position.put("side defenser",new ArrayList<member>());
        position.put("defensive midfielder",new ArrayList<member>());
        position.put("attacktive midfielder",new ArrayList<member>());
        position.put("wings",new ArrayList<member>());
        position.put("center striker",new ArrayList<member>());
    }
